...
AI processing must remain visible and local. Processing jobs may summarize user-started sessions, but they must not add hidden capture, remote calls, deceptive automation, or monitoring evasion.
